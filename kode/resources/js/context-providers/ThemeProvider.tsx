...
// Define the shape of themeSettings
...
const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (savedSettings) {
      initialSettings = JSON.parse(savedSettings) as ThemeSettings;
    } else {
  ...
  useEffect(() => {
    const updateDirection = () => {
      ...
      if (themeSettings.dir === "rtl") {
        link.href = "../../node_modules/bootstrap/dist/css/bootstrap.rtl.min.css";
      } else {
        link.href = "../../node_modules/bootstrap/dist/css/bootstrap.min.css";
      }
  ...
  return (
    <ThemeContext.Provider value={{ themeSettings, toggleTheme, toggleDirection }}>
      {children}
    </ThemeContext.Provider>
  );
};
