        ...
        <div className="w-100 d-flex justify-content-between align-items-center">
          ...
          <div className="nav-right">
            <button className="header-action" onClick={toggleTheme}>
              {themeSettings.theme === "light" ? <BsMoon /> : <BsSunFill />}
            </button>

            <button className="header-action" onClick={toggleDirection}>
              <BsViewList />
            </button>
            ...
            <Dropdown>
              ...
              <Dropdown.Menu>
                <ul className="dropdown--profile">
                  ...
                  <li>
                    <span>
                      <LuBellRing className="fs-18 me-2" />
                    </span>
                    <span>Subscription & Credit</span>
                  </li>
                  <li>
                    <span>
                      <LuWallet className="fs-18 me-2" />
                    </span>
                    <span>Billing</span>
                  </li>
                  <li>
                    <span>
                      <LuCircleArrowUp className="fs-18 me-2" />
                    </span>
                    <span>Upgrade your account</span>
                  </li>
                  <li>
                    <Link to={`/login`} className="d-inline-block w-full">
                      <span>
                        <LuLogOut className="fs-18 me-2" />
                      </span>
                      <span>Sign out</span>
                    </Link>
                  </li>
