      ...
      <div className="row g-4">
        ...
        <div className="col-12">
          <div className="row g-2">
            <div className="col-2">
              <Field>
                <select className="form-select" id="hour" aria-label="State">
            ...
            <div className="col-2">
              <Field>
                <select className="form-select" id="minute" aria-label="State">
                  <option value="1">01</option>
                  <option value="2">02</option>
                  <option value="3">03</option>
                  <option value="4">04</option>
            ...
            <div className="col-12">
              <span className="fs-14 fw-bold">Asia/Dhaka GMT +06:00</span>
            </div>
          </div>
        </div>
      </div>
