                ...
                <div className="message-body">
                    <div className="message-container">
                        <div className="message-content position-relative">
                            <p>
                                After it is possible to send the client
                                messages, The input box will be present
                                (Otherwise it needs to be hidden). The input
                                field must contain the basics that WhatsApp
                                already provides. Such as sending plain text,
                                adding emojis, text to speech, adding files,
                                photos, audio, location, create buttons.
                            </p>
                            {pathValue === "inbox" && (
