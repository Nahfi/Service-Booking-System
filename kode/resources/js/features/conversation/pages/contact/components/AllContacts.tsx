...
import { RiUserFollowLine, RiUserForbidLine, RiUserLine } from "react-icons/ri";
        ...
        <>
            ...
            <div>
                ...
                <div className="row row-cols-xl-3 g-4 mb-4">
                    <div className="col">
                        <div className="contact-status-card d-flex align-items-center justify-content-between">
                            <div>
                                <p className="mb-1">Total Contacts</p>
                                <h6>2105</h6>
                            </div>

                            <div className="icon-btn dark-soft btn-lg rounded-circle cursor-none flex-shrink-0">
                                <RiUserLine />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col">
                        <div className="contact-status-card d-flex align-items-center justify-content-between">
                            <div>
                                <p className="mb-1">Active contacts</p>
                                <h6>75.25%</h6>
                            </div>
                            <div className="icon-btn success-soft btn-lg rounded-circle cursor-none flex-shrink-0">
                                <RiUserFollowLine />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col">
                        <div className="contact-status-card d-flex align-items-center justify-content-between">
                            <div>
                                <p className="mb-1">Contact Blacklisted</p>
                                <h6>150</h6>
                            </div>
                            <div className="icon-btn danger-soft btn-lg rounded-circle cursor-none flex-shrink-0">
                                <RiUserForbidLine />
                            </div>
                        </div>
                    </div>
