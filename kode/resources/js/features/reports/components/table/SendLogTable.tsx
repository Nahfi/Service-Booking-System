            ...
            <tbody>
                {Array.from({ length: 7 }).map((_, ind) => (
                    <tr key={ind}>
                        ...
                        <td>
                            <div>
                                <p className="fs-14">Summer Sale Campaign 2024</p>
                                <div className="d-flex align-items-center gap-2 mt-1 lh-1">
                                    <button
                                        aria-label={
                                            stopCampaign ? "Start campaign" : "Stop campaign"
                                        }
                                        className="bg--transparent text-primary flex-shrink-0"
                                        onClick={() => handleStopCampaign(ind)}
                                    >
                                        {stopCampaign[ind] ? (
                                    ...
                                    <div className="campaign-progress flex-grow-1">
                                        <ProgressBar now={60} animated={stopCampaign[ind]} />
                                    </div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <span className="i-badge pill success-soft lh-1 py-2">
                                <BsFillCheckCircleFill className="me-1" /> Sent
                            </span>
                        </td>
                        ...
                        <td>
                            <div className="d-flex align-items-center justify-content-end gap-2">
                                <button className="icon-btn dark-soft hover btn-md fs-16 rounded-3">
